...
const DEFAULT_SUBS = [
  '李老师，你专注做实验的样子就很美。',
  '与其向往未来，不如现在出发，通往药监局的路就在李总脚下。',
  '慢慢理解晦涩的药理，慢慢更新自己，别急，我在。',
  '关关难过关关过，不管论文多难写，前路漫漫亦灿灿。',
  '生活原本沉闷，但李老师跑起来就有风，带上我一起吹风就更好了。',
  '在这路遥马急的人间，李总平安就好，我在身边就好。',
  '虽然读研辛苦，但我知道你会选择那种滚烫的人生，我在身边',
  '生活里的不期而遇，都是努力后的惊喜，希望我也是李老师的一个惊喜。',
  '把不忙不闲的实验做得出色，把不咸不淡的生活过得精彩，累了就回头，我在。',
  '凡是过往皆为序章，愿李总未来入职药监局，凡是未来皆有可期。',
  '李老师，读研路上有我呢',
  '李总，我喜欢你',
]
